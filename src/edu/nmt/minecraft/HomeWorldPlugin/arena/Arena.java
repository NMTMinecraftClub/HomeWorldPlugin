...
public class Arena implements Listener{
	...
	public Arena(){
		...
		currentFight = false;
		exitLocation = new Location(Bukkit.getWorld("HomeWorld"), 288, 78, 179);
	}
	...
	private boolean blueSwitchPressed(PlayerInteractEvent event) {
		...
		if (event.getClickedBlock().getLocation().equals(new Location(Bukkit.getWorld("HomeWorld"), 288, 72, 178))){
			return true;
		}
		return false;
	}
	...
	private boolean redSwitchPressed(PlayerInteractEvent event) {
		...
		if (event.getClickedBlock().getLocation().equals(new Location(Bukkit.getWorld("HomeWorld"), 288, 72, 182))){
			return true;
		}
		return false;
	}
